...
const AddButton = ({ isVariant }: IAddButton) => {
  return isVariant ? (
    <div className="w-fit p-4 border-black rounded-full bg-yellow">
      <svg
    ...
    <div className="w-fit p-2 border-white border-2 rounded-full ">
      <svg
        aria-label="adicionar mais items"
        width="16"
        height="16"
